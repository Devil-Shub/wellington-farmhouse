...
export default {
  ...
  mounted: function() {
    // use your own key...
    $Scriptjs("https://maps.googleapis.com/maps/api/js?key=https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyAQEbFYBxoq9qSepomK_1KEM7TxU3vSOyw&libraries=geometry,places", () => {
      this.initMap();
    });
